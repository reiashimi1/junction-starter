    ...
    },
    {
      ...
      renderCell: (params) => (
        <div className="flex justify-end">
          <img
            src={prepareImagePath(params.row.main_image)}
            ...
            <div className="flex flex-col bg-slate-200 p-4 rounded-xl shadow-md sm:space-y-8">
              <div className="flex lg:flex-row flex-col lg:justify-around lg:space-y-0 sm:space-y-4">
                <div className="flex flex-1 sm:flex-row flex-col">
                  ...
                  <RowData label="City" value={order.city || order.user.city} />
                </div>
                <div className="flex flex-1 sm:flex-row flex-col">
              ...
              <div className="flex lg:flex-row flex-col lg:justify-around lg:space-y-0 sm:space-y-4">
                <div className="flex flex-1 sm:flex-row flex-col">
                  <RowData label="Email" value={order.user.email} />
                  <RowData label="Full name" value={order.user.name} />
                </div>
                <div className="flex flex-1 sm:flex-row flex-col">
                  <RowData
                    label="Phone number"
                    value={order.phone_number || order.user.phone_number}
                  />
                  <RowData showBorder={false} />
                </div>
              </div>
...
export default withAuth(OrderDetailsView);
