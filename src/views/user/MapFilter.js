...
import {Dock, DockOutlined, ElectricalServices, EvStation, Power} from "@mui/icons-material";
                ...
                <div>
                  <div>
                    <FormControl className="ml-2">
                      <FormLabel id="demo-row-radio-buttons-group-label " sx={{marginLeft: 2}}>
                        Charger type
                      </FormLabel>
                      <RadioGroup
                          sx={{marginLeft: 1}}
                      ...
                      >
                        ...
                        <Divider className="mt-4 mb-4" />
                        <FormLabel id="demo-row-radio-buttons-group-label " sx={{marginLeft: 2}}>
                            Connector Type </FormLabel>
                        <Box sx={{ padding: 1, marginTop: '10px'}}>
                            <Grid container spacing={1} >
                                {connectors.map((connector, index) => (
                                    <Grid item key={index}>
                                        <Paper sx={{ backgroundColor: "blue", paddingLeft: 1, paddingRight: 1, textAlign: 'center' }} >
                                            {connector.icon}
                                            <div>
                                                {connector.name}
                                            </div>
