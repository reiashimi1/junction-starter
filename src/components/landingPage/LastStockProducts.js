...
const LastStockProducts = ({ products }) => {
  return (
    <div className="py-10 p-5 w-full flex flex-col justify-center bg-gradient-to-b from-midnightBlue-700 to-darkMagneta-600 text-white">
...
export default LastStockProducts;
